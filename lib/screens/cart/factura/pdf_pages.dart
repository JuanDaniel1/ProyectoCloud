  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async{
    ...
    doc.addPage(
      ...
      pw.MultiPage(
        ...
        pw.Center(
            child: pw.Text('Factura', textAlign: pw.TextAlign.center, style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 30))
        ),
    ...
    pw.Text("\$${item.carritoPrecioUnitario} x ${item.carritoCantidad}"),
    ...
    children: [
    pw.Text('Total:'),
    pw.Text("\$${widget.model
        .map((carrito) => int.parse(carrito.carritoSubtotal!))
        .fold(0, (a, b) => a + b)}"),
    ],
    ),)
